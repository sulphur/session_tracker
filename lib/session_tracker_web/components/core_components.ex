defmodule SessionTrackerWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(SessionTrackerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(SessionTrackerWeb.Gettext, "errors", msg, opts)
    end
  end
